...
controller, and unsigned containing-app/System Extension product graph are built; signing and
System Extension activation are not, so this is still not installed enforcement. See ADRs
0035–0036 and 0043–0045 and the
...
network, database, IPC, or shared-container writes from the data provider. An installable bundle,
activation, and entitled-device notification/health remain unimplemented.
